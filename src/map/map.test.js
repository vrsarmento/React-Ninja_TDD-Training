...
it('map([3, 4], (item) => item + 2) should return [5, 6]', () => {
  expect(map([3, 4], item => item + 2)).to.be.deep.equal([5, 6])
})

it('map([1], (item, index) => index) should return [0]', () => {
  expect(map([1], (item, index) => index)).to.be.deep.equal([0])
})
